...
import svg from "./cloud.svg?raw";

export const cloud: CharacterDef = {
  id: "cloud",
  name: "Cloud",
  description: "Soft and fluffy — drifts gently, rains when stressed",
  svg,
  actions: {
    idle: { cssClass: "char-slot-idle", duration: 4000, randomOffset: true, randomOffsetMax: 2 },
    think: { cssClass: "char-slot-active", duration: 2500 },
